...
public class EmployeeView {
	...
	List<Employee> empList = new ArrayList<>(); // 사원을 저장할 리스트 생성
	...
	public void selectAll() {
		...
		// DB에서 전체 사원정보를 조회하여 List<Employee> 형태로 반환하는
		// selectAll() 메서드 호출
	...
	public void selectEmpNo() {
		System.out.println("<주민등록번호 일치하는 사원 조회>");
	...
	public void insertEmployee() {
		...
		Employee emp = new Employee(empId, empName, empNo, email,
						phone, salary, deptCode, jobCode, salLevel, 
						bonus, managerId);
